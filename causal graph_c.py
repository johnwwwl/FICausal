...
with dot.subgraph(name='cluster_red') as t:
    ...
    t.node('Conscientiousness', 'Conscientiousness', shape='ellipse', color='#ffb3b3', width=node_width, height=node_height,fontsize=font_size, style='filled,bold')
